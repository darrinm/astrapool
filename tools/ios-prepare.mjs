...
for (const entry of ['brand', 'environments', 'planets', 'sfx', 'favicon.ico', 'favicon.png', 'apple-touch-icon.png']) {
...
await writeFile(resolve(outDir, 'index.html'), html.replace(/^.*<link[^>]+https:\/\/fonts\.[^>]+>\s*$/gm, ''));
